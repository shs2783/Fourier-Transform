...
class ConvSTFT(nn.Module):
    def __init__(self, win_len, hop_size, fft_len=None, win_type='hamming', feature_type='real', fix=True):
        ...
        kernel, _ = init_kernels(win_len, hop_size, self.fft_len, win_type)
